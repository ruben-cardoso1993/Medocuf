        ...
        <form class="form-horizontal" align=center  method="post" action="FichasAptidao.php">
            ...
            <div class="container bg-3" align="center">        
                    <table class="table" id="myTable">
						...
						<td>
							 <button type="button" name="<?php echo"{$row['ID_cliente']}";?>" id="btnGerarPDFUtilizador" class="glyphicon glyphicon-floppy-save" method="post"  onclick="window.location.href= 'ColaboradorCliente.php?idColaborador=<?php echo"{$row['ID_cliente']}";?>'"  target="_blank"></button>
						</td>
					    </tr>
					        <?php
					        } 
