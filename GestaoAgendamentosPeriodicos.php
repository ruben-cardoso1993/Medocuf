                ...
                <div class="container bg-3" align="center">        
                    <table class="table" id="myTable">
                        ...
                        <?php
				            ...
				            $sql ="SELECT c.Nome as Nome, cl.Nome as NomeCliente, /*DATE_ADD(DAAF, INTERVAL 1 YEAR) as DAAF*/ DCO, DCOH FROM colaboradores c ";
                            $sql .= " Left join clientes cl on c.ID_cliente = cl.ID_cliente Order by DCO ASC";
