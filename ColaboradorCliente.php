...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="FichasAptidao.php"><span class="glyphicon glyphicon-log-in"></span> VOLTAR</a></li>
    </ul>
  </div>
</nav>
...
if(isset($_POST['Procura'])){
    if($valueToSearch = $_POST['nomedocolaborador']){
...
<div clas="container-fluid bg-3 text-center">
    <div class="container" id="FichasAptidao">
        <form class="form-horizontal" align=center  method="post" action="FichasAptidao.php">
            <div class="form-group">
                </br>
                <label class="control-label col-sm-2" name="NomeCliente">Nome do colaborador:</label>      
                    <div class="col-sm-8">
            ...
            <div class="container bg-3" align="center">        
                    <table class="table" id="myTable">
                        ...
                        <?php
				            ...
				            $sql ="SELECT c.Nome FROM colaboradores c WHERE c.ID_cliente =" .$idColaborador1."";
				            $result=mysqli_query($con,$sql) or die("Query incorrecta: $sql");
				            if($filter_Result=""){ 
						...
						<td>
							 <button type="button" name="<?php echo"{$row['ID_colaborador']}";?>" id="btnGerarPDFUtilizador" class="glyphicon glyphicon-floppy-save" method="post"  onclick="window.location.href= 'GerarPDF.php?idColaborador=<?php echo"{$row['ID_colaborador']}";?>'"  target="_blank"></button>
