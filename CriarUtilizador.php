...
<div clas="container-fluid bg-3 text-center">
    <div class="container" id="criarutilizador">
        <form class="form-horizontal" align=center  method="post" action="InserirUtilizadoresBD.php">
        ...
        <form action="PaginaPrincipal.php"  method="post" align=center name="Voltar"id="apagar" autocomplete="off">
            </br> 
            </br> 
