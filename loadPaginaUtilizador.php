<?php
    ...
    $count = 0;
    $sql1 ="SELECT ID_colaborador, DAAF, DataLimite  from colaboradores ";
    ...
    while($row1=mysqli_fetch_assoc($result1)){
        ...
        if($dateToday>$datalimite){
            $dataLimite_1Year = date("Y-m-d", strtotime(date("Y-m-d", strtotime($datalimite)) . "+1 year"));
            $sql2='UPDATE colaboradores set DataLimite = "'.$dataLimite_1Year.'" where ID_colaborador = '.$row1["ID_colaborador"].' ';
